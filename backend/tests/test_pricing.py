...
def test_openai_costs(client, application):
    ...
    # act
    response = client.get(
        "/api/transactions?page=1&page_size=100"
    )
    ...
    assert case10["total_cost"] - 0.00001 <= 0.002810000 <= case10["total_cost"] + 0.00001
    assert case11["total_cost"] - 0.00001 <= 0.007380000 <= case11["total_cost"] + 0.00001
    assert case12["total_cost"] - 0.00001 <= 0.003230000 <= case12["total_cost"] + 0.00001
    assert case13["total_cost"] - 0.00001 <= 0.003250000 <= case13["total_cost"] + 0.00001
    assert case14["total_cost"] - 0.00001 <= 0.003670000 <= case14["total_cost"] + 0.00001
    assert case15["total_cost"] - 0.00001 <= 0.000010660 <= case15["total_cost"] + 0.00001
    assert case16["total_cost"] - 0.00001 <= 0.000130000 <= case16["total_cost"] + 0.00001
    assert case17["total_cost"] - 0.00001 <= 0.000150000 <= case17["total_cost"] + 0.00001
...
def test_azure_costs(client, application):
    ...
    data = [item for item in response.json()["items"] if item["provider"] == "Azure OpenAI"]
    ...
    case14 = [item for item in data if item["model"] == "gpt-3.5-turbo-instruct-0914"][0]
    ...
    assert case16["total_cost"] - 0.00001 <= 0.010080000 <= case16["total_cost"] + 0.00001
    ...
    assert case22["total_cost"] - 0.00001 <= 0.000120000 <= case22["total_cost"] + 0.00001
    assert case23["total_cost"] - 0.00001 <= 0.000150000 <= case23["total_cost"] + 0.00001
...
def test_anthropic_costs(client, application):
    ...
    data = [item for item in response.json()["items"] if item["provider"] == "Anthropic"]
