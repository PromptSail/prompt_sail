            ...
            >
                ...
                >
                    ...
                    <Paragraph className="!mb-[8px] text-Text/colorTextDescription">
                        You have been assigned automatically as owner. However, you can change it at
                        any time.
                    </Paragraph>
                    <Select className="max-w-[50%]" size="large" onChange={formik.handleChange} />
                </Form.Item>
                <Form.Item<typeof FormikValuesTemplate>
                    rules={[{ required: true }]}
                ...
                >
                    ...
                    <Paragraph className="!mb-[8px] text-Text/colorTextDescription">
                        A slug used to identify project is uniqe and utilized as a part of the proxy
                        URL
                    </Paragraph>
                    <Input
                        name="slug"
